...
def forwards_func(apps, schema_editor):
    ...
    pro_model.objects.create(
        ...
        description="Признанная критиками франшиза Assassin’s Creed возвращается на PlayStation 4 вместе с новыми историями и заданиями, новым впечатляющим миром и полностью обновленной боевой системой.\r\nAssassins Creed Odyssey: Пройдите путь от изгоя до живой легенды: отправьтесь в далекое странствие, чтобы раскрыть тайны своего прошлого и изменить будущее Древней Греции. Вас ждет совершенно новая боевая система и морские путешествия в огромном бесшовном мире, который постоянно развивается и реагирует на каждое ваше действие.\r\nAssassins Creed Origins: Раскройте тайны Древнего Египта и узнайте, как было создано Братство ассасинов.",
        price=3200,
        quantity=50,
        category=pro_cat_obj,
        developer="Ubisoft",
