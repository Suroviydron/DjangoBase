...
def products(request):
    ...
    same_products = [
        {"name": "Отличный светильник", "desc": "Не оторваться.", "image_src": "product-11.jpg", "alt": "продукт 11"},
        {"name": "Стул повышенного качества", "desc": "Комфортно.", "image_src": "product-21.jpg", "alt": "продукт 21"},
        {"name": "Светильник премиального качества", "desc": "Просто включите.", "image_src": "product-31.jpg",
         "alt": "продукт 31"},
    ]
